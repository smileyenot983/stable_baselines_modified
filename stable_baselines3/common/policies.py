...
class ActorCriticPolicy(BasePolicy):
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False, parameter_noise=False, sigma=1e-8) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        """
        ...
        """
        latent_pi, latent_vf, latent_sde = self._get_latent(obs,parameter_noise=parameter_noise,sigma=sigma)
    ...
    def _get_latent(self, obs: th.Tensor, parameter_noise=False, sigma=1e-8) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        """
        ...
        # print("parameter_noise")
        # print(parameter_noise)
        # print("parameter_noise_over")
        features = self.extract_features(obs)
        latent_pi, latent_vf = self.mlp_extractor(features, parameter_noise, sigma)
